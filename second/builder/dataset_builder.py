...
from second.data.preprocess import prep_data_aug, prep_main, prep_add_targets
...
def build(input_reader_config,
    ...
    prep_func_main = partial(prep_func_main, anchor_cache=anchor_cache)
    dataset = dataset_cls(
        info_path=dataset_cfg.kitti_info_path,
        root_path=dataset_cfg.kitti_root_path,
        class_names=class_names,
        prep_func_data_aug=prep_func_data_aug,
        prep_func_main=prep_func_main,
        prep_func_add_targets=prep_func_add_targets)
