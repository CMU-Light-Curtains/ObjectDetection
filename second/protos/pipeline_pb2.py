...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  syntax='proto3',
  serialized_pb=_b('\n\x1csecond/protos/pipeline.proto\x12\rsecond.protos\x1a second/protos/input_reader.proto\x1a\x19second/protos/model.proto\x1a\x19second/protos/train.proto\"\xa0\x02\n\x17TrainEvalPipelineConfig\x12,\n\x05model\x18\x01 \x01(\x0b\x32\x1d.second.protos.DetectionModel\x12\x36\n\x12train_input_reader\x18\x02 \x01(\x0b\x32\x1a.second.protos.InputReader\x12\x30\n\x0ctrain_config\x18\x03 \x01(\x0b\x32\x1a.second.protos.TrainConfig\x12\x36\n\x12valid_input_reader\x18\x04 \x01(\x0b\x32\x1a.second.protos.InputReader\x12\x35\n\x11\x65val_input_reader\x18\x05 \x01(\x0b\x32\x1a.second.protos.InputReaderb\x06proto3')
  ,
...
_TRAINEVALPIPELINECONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='valid_input_reader', full_name='second.protos.TrainEvalPipelineConfig.valid_input_reader', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='eval_input_reader', full_name='second.protos.TrainEvalPipelineConfig.eval_input_reader', index=4,
...
_TRAINEVALPIPELINECONFIG.fields_by_name['valid_input_reader'].message_type = second_dot_protos_dot_input__reader__pb2._INPUTREADER
